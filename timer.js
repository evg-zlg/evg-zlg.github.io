...
function printCircles(circles) {
    let str = '<ul style = "color: black; font-size: 20px;">' 
    ...
    runButton.addEventListener('click', cel => {
        if (runButton.className === 'start') {
            ...
            document.getElementById('run').style = 'position: fixed; bottom: 0; left:0; ' +
                'width: 100%;  height: 15mm; border-radius: 4px; margin: center'+
                'box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19);'+
            ...
            document.getElementById('baseinf').style = 'visibility: hidden;'
            ...
            document.getElementById('baseinf').style = 'visibility: visible;'
            document.getElementById('timer').textContent = timerGlob;
